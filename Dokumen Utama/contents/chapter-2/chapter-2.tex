...
Posisi objek pada bidang dua dimensi dengan Trilaterasi 2D didapatkan dengan menyelesaikan tiga persamaan lingkaran yang merepresentasikan dari setiap satelit.
...
\begin{enumerate}
	...
	\item \textbf{\textit{Position Dilution of Precision} (PDOP)}: Merupakan gabungan dari HDOP dan VDOP. Selain itu, PDOP juga mendeskripsikan persebaran satelit di langit. Semakin kecil nilai PDOP maka posisi satelit semakin tersebarsehingga akurasi yang didapat semakin besar.
\end{enumerate}
